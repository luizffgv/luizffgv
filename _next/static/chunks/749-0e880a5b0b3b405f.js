(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[749],{429:function(e,a,t){"use strict";t.d(a,{Z:function(){return n}});var i=t(7437),o=t(2265),s=t(8656),r=t.n(s);function n(e){let{children:a,onDismiss:t,noCard:s}=e,n=(0,o.useRef)(null);return(0,o.useEffect)(()=>{if(null==n.current){console.error("dialogRef.current is null.");return}n.current.showModal()},[]),(0,i.jsxs)("dialog",{ref:n,className:"".concat(r()["modal-container"]," raiar flex-col align-items-center justify-content-safe-center gap"),onClose:()=>null==t?void 0:t(),children:[t?(0,i.jsx)("button",{type:"button",className:r().dismiss,onClick:()=>t(),"aria-label":"Fechar modal",children:(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":!0,children:"close"})}):(0,i.jsx)(i.Fragment,{}),(0,i.jsx)("div",{className:"".concat(r().modal," ").concat(s?"":"raiar-card"),children:a})]})}},7749:function(e,a,t){"use strict";t.r(a),t.d(a,{default:function(){return y}});var i=t(7437),o=t(2265);let s=(0,o.createContext)({filter:e=>e,setFilter:()=>{}});function r(e,...a){let t=a.map(String);return t.push(""),e.map((e,a)=>e+t[a]).reduce((e,a)=>e+a)}let n=[{name:"Blink: Ultimate Teleportation",description:"Instalado por mais de 32 mil usu\xe1rios diferentes, Blink \xe9 um mod feito em Lua para o jogo Teardown.",details:r`
    ...
    `,tags:["Discord App","GitHub","JavaScript","Node.js","TypeScript"],license:"MIT License",repository:"https://github.com/luizffgv/spirit-box",image:"Spirit Box"},{name:"TS Conversions",description:"Biblioteca e pacote NPM fornecendo utilit\xe1rios para realizar convers\xf5es seguras ou inseguras e diminuir c\xf3digo boilerplate no TypeScript. Tamb\xe9m \xe9 utilizada nesse site.",tags:["Biblioteca","GitHub Actions","GitHub","JavaScript","Node.js","Pacote NPM","TypeScript"],license:"MIT License",url:"https://www.npmjs.com/package/@luizffgv/ts-conversions",repository:"https://github.com/luizffgv/ts-conversions"},{name:"Viewport-Based Scaling",description:"Site que gera CSS para definir o valor de uma propriedade baseado na largura do viewport, realizando interpola\xe7\xe3o linear entre v\xe1rios pares de pontos.",tags:["GitHub","GitHub Actions","HTML","JavaScript","Node.js","Site","TypeScript","Webpack"],license:"MIT License",url:"https://vbs.luizf.dev",repository:"https://github.com/luizffgv/viewport-based-rescaling"}];var l=t(6585),c=t.n(l),d=t(5313);let u=[...n.map(e=>e.tags).reduce((e,a)=>{for(let t of a)e.add(t);return e},new Set)].sort();function p(e,a){var t;return new Set((null!==(t=e.tags)&&void 0!==t?t:[]).filter(e=>a.has(e)))}function m(){let e=(0,d.useSearchParams)(),{setFilter:a}=(0,o.useContext)(s),[t,r]=(0,o.useState)("best-match"),[n,l]=(0,o.useState)({value:new Set}),m=(0,o.useRef)(null);return(0,o.useLayoutEffect)(()=>{l({value:new Set(e.getAll("tags").filter(e=>u.includes(e)))}),null==m.current?console.error("detailsRef is null."):null!=e.get("tags")&&(m.current.open=!0)},[e]),(0,o.useEffect)(()=>{a(e=>{let a=[...e].sort((e,a)=>p(a,n.value).size-p(e,n.value).size);return n.value.size>0&&(a=a.filter(e=>p(e,n.value).size>0)),"every"==t&&(a=a.filter(e=>{for(let t of n.value){var a;if(!(null===(a=e.tags)||void 0===a?void 0:a.includes(t)))return!1}return!0})),a})},[t,n,a]),(0,i.jsx)("div",{className:"".concat(c().container," raiar flex-col align-items-center"),children:(0,i.jsx)("div",{className:"width-fit",children:(0,i.jsxs)("details",{ref:m,children:[(0,i.jsx)("summary",{children:"Filtros"}),(0,i.jsxs)("div",{className:"raiar flex-row flex-wrap gap",children:[(0,i.jsxs)("fieldset",{className:"".concat(c().tags," raiar flex-row flex-wrap gap"),onChange:e=>{if(!(e.target instanceof HTMLInputElement)){console.error("event.target is not an HTMLInputElement");return}e.target.checked?n.value.add(e.target.value):n.value.delete(e.target.value),l({value:n.value})},children:[(0,i.jsx)("legend",{children:"Selecione tags"}),u.map(e=>(0,i.jsxs)("label",{children:[e," ",(0,i.jsx)("input",{type:"checkbox",value:e,checked:n.value.has(e),onChange:()=>{}})]},e))]}),(0,i.jsxs)("fieldset",{onChange:e=>{if(!(e.target instanceof HTMLInputElement)){console.error("event.target is not an HTMLInputElement");return}r(e.target.value)},children:[(0,i.jsx)("legend",{children:"L\xf3gica de filtragem"}),(0,i.jsxs)("label",{children:[(0,i.jsx)("input",{type:"radio",name:"project-filter-mode",value:"best-match",defaultChecked:!0}),"Melhor correspond\xeancia"]}),(0,i.jsxs)("label",{children:[(0,i.jsx)("input",{type:"radio",name:"project-filter-mode",value:"every"}),"Possui todas categorias selecionadas"]})]})]})]})})})}var g=t(728),f=t.n(g),h=t(429),v=t(1642),b=t.n(v);function j(e){let{project:a}=e;return(0,i.jsxs)("div",{className:"raiar-card width-fit",children:[null==a.image?(0,i.jsx)(i.Fragment,{}):(0,i.jsx)("div",{className:"raiar flex-row justify-content-center",children:(0,i.jsx)("img",{className:b().image,src:"/project-images/".concat(a.image,".webp"),alt:a.name})}),(0,i.jsxs)("div",{className:b().content,children:[(0,i.jsx)("h1",{children:a.name}),(0,i.jsx)("p",{children:a.description}),null==a.details?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("h2",{children:"Detalhes"}),(0,i.jsx)("div",{dangerouslySetInnerHTML:{__html:a.details}})]})]})]})}function x(e){let{project:a}=e,[t,s]=(0,o.useState)(!1);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsxs)("div",{className:"".concat(f().project," raiar-card raiar align-items-center flex-col gap justify-content-between"),role:"group","aria-label":a.name,children:[(0,i.jsxs)("div",{className:"".concat(f()["title-container"]," raiar flex-row gap flex-wrap align-items-center justify-content-center"),style:{minHeight:"48px"},children:[null==a.image?(0,i.jsx)(i.Fragment,{}):(0,i.jsx)("img",{className:f().image,src:"/project-images/".concat(a.image,".webp"),alt:a.name}),(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap align-items-baseline",children:[(0,i.jsxs)("h3",{children:[a.name," ",a.wip?"(em progresso)":""]}),(0,i.jsx)("small",{className:f().license,children:a.license})]})]}),(0,i.jsx)("p",{children:a.description}),(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap justify-content-center",children:[null==a.url?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)("a",{className:"".concat(f()["button-view"]," button"),href:a.url,target:"_blank",children:[(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":"true",children:"visibility"}),"Visualizar"]}),null==a.repository?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)("a",{className:"button",href:a.repository,target:"_blank","aria-label":"Reposit\xf3rio",children:[(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":"true",children:"code"}),"Reposit\xf3rio"]}),null==a.details?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)("button",{type:"button",className:f()["button-details"],onClick:()=>s(!0),children:[(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":"true",children:"add"}),"Detalhes"]})]})]}),t?(0,i.jsx)(h.Z,{onDismiss:()=>s(!1),noCard:!0,children:(0,i.jsx)(j,{project:a})}):(0,i.jsx)(i.Fragment,{})]})}var S=t(3444),w=t.n(S);function _(){let{filter:e}=(0,o.useContext)(s),a=(0,o.useMemo)(()=>e(n),[e]);return(0,i.jsx)("ul",{className:"".concat(w().list," no-list-style raiar flex-row flex-wrap gap-2x justify-content-center"),children:a.map(e=>(0,i.jsx)("li",{className:"display-contents",children:(0,i.jsx)(x,{project:e})},e.name))})}function y(){let[e,a]=(0,o.useState)(()=>e=>e),t=(0,o.useCallback)(e=>a(()=>e),[]),r=(0,o.useRef)(null);return(0,o.useLayoutEffect)(()=>{if(null==r){console.error("projectsListRef is null");return}new Animation(new KeyframeEffect(r.current,[{opacity:0},{}],{duration:500,easing:"ease"})).play()},[e]),(0,i.jsx)("section",{className:"raiar flex-col gap-2x align-center","aria-labelledby":"heading-projects",children:(0,i.jsxs)(s.Provider,{value:{filter:e,setFilter:t},children:[(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap justify-content-center",children:[(0,i.jsx)("h2",{children:"Meus projetos"}),(0,i.jsx)(o.Suspense,{children:(0,i.jsx)(m,{})})]}),(0,i.jsx)("div",{ref:r,children:(0,i.jsx)(_,{})})]})})}},8656:function(e){e.exports={"modal-container":"modal_modal-container__CjvJZ",dismiss:"modal_dismiss__uuQxh",modal:"modal_modal__noGlo"}},6585:function(e){e.exports={container:"project-filter-selector_container__HqZSA","fade-in-2":"project-filter-selector_fade-in-2__oS0d4","fade-in":"project-filter-selector_fade-in__iq0_o",tags:"project-filter-selector_tags__TxW2X"}},728:function(e){e.exports={project:"project-preview_project__VM549","slide-in":"project-preview_slide-in__Ob6r0","title-container":"project-preview_title-container__WZbAq",image:"project-preview_image__mPSMn",license:"project-preview_license__Op7LG","button-details":"project-preview_button-details__h4Wtm",wiggle:"project-preview_wiggle__st5iI","button-view":"project-preview_button-view__d__V6","eye-blink":"project-preview_eye-blink__vWdLG"}},1642:function(e){e.exports={image:"project_image__P3LqK",content:"project_content__2jOat"}},3444:function(e){e.exports={list:"projects-list_list__T93GK"}}}]);