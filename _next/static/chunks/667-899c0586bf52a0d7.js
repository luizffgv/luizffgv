(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[667],{2529:function(e,a,t){"use strict";t.r(a),t.d(a,{default:function(){return m}});var i=t(7437),o=t(8792),s=t(2265),r=t(6484),n=t.n(r),l=t(8656),c=t.n(l);function d(e){let{children:a,onDismiss:t,noCard:o}=e,r=(0,s.useRef)(null);return(0,s.useEffect)(()=>{if(null==r.current){console.error("dialogRef.current is null.");return}r.current.showModal()},[]),(0,i.jsxs)("dialog",{ref:r,className:"".concat(c()["modal-container"]," raiar flex-col align-items-center justify-content-safe-center gap"),onClose:()=>null==t?void 0:t(),children:[t?(0,i.jsx)("div",{className:c().dismiss,children:(0,i.jsx)(m,{onClick:t,"aria-label":"Fechar modal",children:(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":!0,children:"close"})})}):(0,i.jsx)(i.Fragment,{}),(0,i.jsx)("div",{className:"".concat(c().modal," ").concat(o?"":"raiar-card"),children:a})]})}function u(e){let[a,t]=(0,s.useState)(!1);return(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("button",{className:"".concat(e.className," ").concat(n().button),onClick:()=>t(!0),"aria-label":e["aria-label"],children:e.children}),a?(0,i.jsx)(d,{onDismiss:()=>t(!1),noCard:e.noCard,children:e.modalContent}):(0,i.jsx)(i.Fragment,{})]})}function m(e){var a,t;return(0,i.jsx)(i.Fragment,{children:"onClick"in e?(0,i.jsx)("button",{...e,className:"".concat(null!==(a=e.className)&&void 0!==a?a:""," ").concat(n().button," button"),type:"button"}):"href"in e?(0,i.jsx)(o.default,{...e,className:"".concat(null!==(t=e.className)&&void 0!==t?t:""," ").concat(n().button," button")}):(0,i.jsx)(u,{...e})})}},9667:function(e,a,t){"use strict";t.r(a),t.d(a,{default:function(){return C}});var i=t(7437),o=t(2265);let s=(0,o.createContext)({filter:e=>e,setFilter:()=>{}});function r(e,...a){let t=a.map(String);return t.push(""),e.map((e,a)=>e+t[a]).reduce((e,a)=>e+a)}let n=[{name:"Blink: Ultimate Teleportation",description:"Instalado por mais de 32 mil usu\xe1rios diferentes, Blink \xe9 um mod feito em Lua para o jogo Teardown.",details:r`
      <p>
    ...
    `,tags:["Discord App","GitHub","JavaScript","Node.js","TypeScript"],license:"MIT License",repository:"https://github.com/luizffgv/spirit-box",image:"Spirit Box"},{name:"TS Conversions",description:"Biblioteca e pacote NPM fornecendo utilit\xe1rios para realizar convers\xf5es seguras ou inseguras e diminuir c\xf3digo boilerplate no TypeScript.",tags:["Biblioteca","GitHub Actions","GitHub","JavaScript","Node.js","Pacote NPM","TypeScript"],license:"MIT License",url:"https://www.npmjs.com/package/@luizffgv/ts-conversions",repository:"https://github.com/luizffgv/ts-conversions"},{name:"Viewport-Based Scaling",description:"Site que gera CSS para definir o valor de uma propriedade baseado na largura do viewport, realizando interpola\xe7\xe3o linear entre v\xe1rios pares de pontos.",tags:["GitHub","GitHub Actions","HTML","JavaScript","Node.js","Site","TypeScript","Webpack"],license:"MIT License",url:"https://vbs.luizf.dev",repository:"https://github.com/luizffgv/viewport-based-rescaling"}];var l=t(6585),c=t.n(l),d=t(5313);let u=[...n.map(e=>e.tags).reduce((e,a)=>{for(let t of a)e.add(t);return e},new Set)].sort();function m(e,a){var t;return new Set((null!==(t=e.tags)&&void 0!==t?t:[]).filter(e=>a.has(e)))}function p(){let e=(0,d.useSearchParams)(),{setFilter:a}=(0,o.useContext)(s),[t,r]=(0,o.useState)("best-match"),[n,l]=(0,o.useState)({value:new Set}),p=(0,o.useRef)(null);return(0,o.useLayoutEffect)(()=>{l({value:new Set(e.getAll("tags").filter(e=>u.includes(e)))}),null==p.current?console.error("detailsRef is null."):null!=e.get("tags")&&(p.current.open=!0)},[e]),(0,o.useEffect)(()=>{a(e=>{let a=[...e].sort((e,a)=>m(a,n.value).size-m(e,n.value).size);return n.value.size>0&&(a=a.filter(e=>m(e,n.value).size>0)),"every"==t&&(a=a.filter(e=>{for(let t of n.value){var a;if(!(null===(a=e.tags)||void 0===a?void 0:a.includes(t)))return!1}return!0})),a})},[t,n,a]),(0,i.jsx)("div",{className:"".concat(c().container," raiar flex-col align-items-center"),children:(0,i.jsx)("div",{className:"width-fit",children:(0,i.jsxs)("details",{ref:p,children:[(0,i.jsx)("summary",{children:"Filtros"}),(0,i.jsxs)("div",{className:"raiar flex-row flex-wrap gap",children:[(0,i.jsxs)("fieldset",{className:"".concat(c().tags," raiar flex-row flex-wrap gap"),onChange:e=>{if(!(e.target instanceof HTMLInputElement)){console.error("event.target is not an HTMLInputElement");return}e.target.checked?n.value.add(e.target.value):n.value.delete(e.target.value),l({value:n.value})},children:[(0,i.jsx)("legend",{children:"Selecione tags"}),u.map(e=>(0,i.jsxs)("label",{children:[e," ",(0,i.jsx)("input",{type:"checkbox",value:e,checked:n.value.has(e),onChange:()=>{}})]},e))]}),(0,i.jsxs)("fieldset",{onChange:e=>{if(!(e.target instanceof HTMLInputElement)){console.error("event.target is not an HTMLInputElement");return}r(e.target.value)},children:[(0,i.jsx)("legend",{children:"L\xf3gica de filtragem"}),(0,i.jsxs)("label",{children:[(0,i.jsx)("input",{type:"radio",name:"project-filter-mode",value:"best-match",defaultChecked:!0}),"Melhor correspond\xeancia"]}),(0,i.jsxs)("label",{children:[(0,i.jsx)("input",{type:"radio",name:"project-filter-mode",value:"every"}),"Possui todas categorias selecionadas"]})]})]})]})})})}var f=t(728),g=t.n(f),h=t(1642),b=t.n(h);function v(e){let{project:a}=e;return(0,i.jsxs)("div",{className:"raiar-card width-fit",children:[null==a.image?(0,i.jsx)(i.Fragment,{}):(0,i.jsx)("div",{className:"raiar flex-row justify-content-center",children:(0,i.jsx)("img",{className:b().image,src:"/project-images/".concat(a.image,".webp"),alt:a.name})}),(0,i.jsxs)("div",{className:b().content,children:[(0,i.jsx)("h1",{children:a.name}),(0,i.jsx)("p",{children:a.description}),null==a.details?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)(i.Fragment,{children:[(0,i.jsx)("h2",{children:"Detalhes"}),(0,i.jsx)("div",{dangerouslySetInnerHTML:{__html:a.details}})]})]})]})}var j=t(2529),x=t(6977),S=t.n(x);function _(e){var a;return(0,i.jsxs)(j.default,{...e,className:"".concat(null!==(a=e.className)&&void 0!==a?a:""," ").concat(S().button),children:[(0,i.jsx)("span",{className:"".concat(S().icon," material-symbols-outlined"),"aria-hidden":"true",children:"visibility"}),e.children]})}function w(e){let{project:a}=e;return(0,i.jsxs)("div",{className:"".concat(g().project," raiar-card raiar align-items-center flex-col gap justify-content-between"),role:"group","aria-label":a.name,children:[(0,i.jsxs)("div",{className:"".concat(g()["title-container"]," raiar flex-row gap flex-wrap align-items-center justify-content-center"),style:{minHeight:"48px"},children:[null==a.image?(0,i.jsx)(i.Fragment,{}):(0,i.jsx)("img",{className:g().image,src:"/project-images/".concat(a.image,".webp"),alt:a.name}),(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap align-items-baseline",children:[(0,i.jsxs)("h3",{children:[a.name," ",a.wip?"(em progresso)":""]}),(0,i.jsx)("small",{className:g().license,children:a.license})]})]}),(0,i.jsx)("p",{children:a.description}),(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap justify-content-center",children:[null==a.url?(0,i.jsx)(i.Fragment,{}):(0,i.jsx)(_,{href:a.url,target:"_blank",children:"Visualizar"}),null==a.repository?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)(j.default,{href:a.repository,target:"_blank","aria-label":"Reposit\xf3rio",children:[(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":"true",children:"code"}),"Reposit\xf3rio"]}),null==a.details?(0,i.jsx)(i.Fragment,{}):(0,i.jsxs)(j.default,{className:g()["button-details"],modalContent:(0,i.jsx)(v,{project:a}),noCard:!0,children:[(0,i.jsx)("span",{className:"material-symbols-outlined","aria-hidden":"true",children:"add"}),"Detalhes"]})]})]})}var y=t(3444),z=t.n(y);function T(){let{filter:e}=(0,o.useContext)(s),a=(0,o.useMemo)(()=>e(n),[e]);return(0,i.jsx)("ul",{className:"".concat(z().list," no-list-style raiar flex-row flex-wrap gap-2x justify-content-center"),children:a.map(e=>(0,i.jsx)("li",{className:"display-contents",children:(0,i.jsx)(w,{project:e})},e.name))})}function C(){let[e,a]=(0,o.useState)(()=>e=>e),t=(0,o.useCallback)(e=>a(()=>e),[]),r=(0,o.useRef)(null);return(0,o.useLayoutEffect)(()=>{if(null==r){console.error("projectsListRef is null");return}new Animation(new KeyframeEffect(r.current,[{opacity:0},{}],{duration:500,easing:"ease"})).play()},[e]),(0,i.jsx)("section",{className:"raiar flex-col gap-2x align-center","aria-labelledby":"heading-projects",children:(0,i.jsxs)(s.Provider,{value:{filter:e,setFilter:t},children:[(0,i.jsxs)("div",{className:"raiar flex-row gap flex-wrap justify-content-center",children:[(0,i.jsx)("h2",{children:"Meus projetos"}),(0,i.jsx)(o.Suspense,{children:(0,i.jsx)(p,{})})]}),(0,i.jsx)("div",{ref:r,children:(0,i.jsx)(T,{})})]})})}},6484:function(e){e.exports={button:"button_button__KSwgv",show:"button_show__IZfUb"}},6977:function(e){e.exports={button:"view-button_button__qtFma",icon:"view-button_icon__Ize3o","eye-blink":"view-button_eye-blink__EiUpi"}},8656:function(e){e.exports={"modal-container":"modal_modal-container__CjvJZ",dismiss:"modal_dismiss__uuQxh",modal:"modal_modal__noGlo"}},6585:function(e){e.exports={container:"project-filter-selector_container__HqZSA","fade-in-2":"project-filter-selector_fade-in-2__oS0d4","fade-in":"project-filter-selector_fade-in__iq0_o",tags:"project-filter-selector_tags__TxW2X"}},728:function(e){e.exports={project:"project-preview_project__VM549","slide-in":"project-preview_slide-in__Ob6r0","title-container":"project-preview_title-container__WZbAq",image:"project-preview_image__mPSMn",license:"project-preview_license__Op7LG","button-details":"project-preview_button-details__h4Wtm",wiggle:"project-preview_wiggle__st5iI"}},1642:function(e){e.exports={image:"project_image__P3LqK",content:"project_content__2jOat"}},3444:function(e){e.exports={list:"projects-list_list__T93GK"}}}]);