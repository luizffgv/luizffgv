(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,76043,e=>{"use strict";let t=(0,e.i(75254).default)("code-xml",[["path",{d:"m18 16 4-4-4-4",key:"1inbqp"}],["path",{d:"m6 8-4 4 4 4",key:"15zrgr"}],["path",{d:"m14.5 4-5 16",key:"e7oirm"}]]);e.s(["CodeXmlIcon",()=>t],76043)},79221,e=>{"use strict";var t=e.i(43476),a=e.i(71645);e.i(47167);var i=e.i(31178),o=e.i(47414),s=e.i(21476),r=a,n=e.i(37806);class l extends r.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if(t&&e.isPresent&&!this.props.isPresent){let e=this.props.sizeRef.current;e.height=t.offsetHeight||0,e.width=t.offsetWidth||0,e.top=t.offsetTop,e.left=t.offsetLeft}return null}componentDidUpdate(){}render(){return this.props.children}}function c({children:e,isPresent:a}){let i=(0,r.useId)(),o=(0,r.useRef)(null),s=(0,r.useRef)({width:0,height:0,top:0,left:0}),{nonce:c}=(0,r.useContext)(n.MotionConfigContext);return(0,r.useInsertionEffect)(()=>{let{width:e,height:t,top:r,left:n}=s.current;if(a||!o.current||!e||!t)return;o.current.dataset.motionPopId=i;let l=document.createElement("style");return c&&(l.nonce=c),document.head.appendChild(l),l.sheet&&l.sheet.insertRule(`
    ...
    `,tags:["Discord App","GitHub","JavaScript","Node.js","TypeScript"],license:"MIT License",repository:"https://github.com/luizffgv/spirit-box",image:"Spirit Box.webp"},{name:"Swapem",description:"Ferramenta CLI e pacote NPM fornecendo uma stream transform que lê texto e substitui diretivas por valores vindos de um arquivo JSON.",tags:["Biblioteca","GitHub","GitHub Actions","JavaScript","Node.js","Pacote NPM","TypeScript"],license:"MIT License",url:"https://www.npmjs.com/package/swapem",repository:"https://github.com/luizffgv/swapem",image:"Swapem.webp"},{name:"TS Conversions",description:"Biblioteca e pacote NPM fornecendo utilitários para realizar conversões seguras ou inseguras e diminuir código boilerplate no TypeScript.",tags:["Biblioteca","GitHub Actions","GitHub","JavaScript","Node.js","Pacote NPM","TypeScript"],license:"MIT License",url:"https://www.npmjs.com/package/@luizffgv/ts-conversions",repository:"https://github.com/luizffgv/ts-conversions"},{name:"Viewport-Based Scaling",description:"Site que gera CSS para definir o valor de uma propriedade baseado na largura do viewport, realizando interpolação linear entre vários pares de pontos.",tags:["GitHub","GitHub Actions","HTML","JavaScript","Node.js","Site","TypeScript","Webpack"],license:"MIT License",url:"https://vbs.luizf.dev",repository:"https://github.com/luizffgv/viewport-based-rescaling",image:"VBS.gif"}];function k(){let{filter:e}=(0,a.useContext)(T),i=(0,a.useMemo)(()=>e(M),[e]);return(0,t.jsxs)("ul",{className:"flex flex-row flex-wrap justify-center gap-8",children:[(0,t.jsx)(g,{children:i.map(e=>(0,t.jsx)(b.motion.li,{className:"contents",layout:!0,children:(0,t.jsx)(w,{project:e})},e.name))}),0===i.length&&(0,t.jsx)("li",{className:"text-center text-xl",children:"Nenhum projeto se encaixa nos filtros."})]})}let H=(0,x.default)("chevron-down",[["path",{d:"m6 9 6 6 6-6",key:"qrunsl"}]]);var L=e.i(18566),N=e.i(7670);function G({value:e,checked:a,onChange:i}){return(0,t.jsxs)("label",{className:(0,N.default)("relative inline-block rounded-lg bg-primary/10 px-2 py-1 text-center text-base transition-all hover:brightness-110 has-[:checked]:bg-primary has-[:checked]:text-fg-on-primary dark:hover:bg-primary/10 dark:has-[:checked]:bg-primary",a&&"active"),children:[(0,t.jsx)("input",{className:"absolute inset-0 cursor-pointer appearance-none rounded-lg",type:"checkbox",value:e,checked:a,onChange:i||(()=>{})}),e]})}let P=new Set(["Bash","C++17","C++20","C18","Doxygen","GitHub","HTML","Livro","Markdown","mdBook","Organização"]),B=[...M.map(e=>e.tags).reduce((e,t)=>{for(let a of t)e.add(a);return e},new Set)].filter(e=>!P.has(e)).toSorted(),q=new Set(Object.values(C).flat()),A=new Set(B.filter(e=>!q.has(e)));function I(e,t){return new Set((e.tags??[]).filter(e=>t.has(e)))}function E(){let e=(0,L.useSearchParams)(),{setFilter:i}=(0,a.useContext)(T),[o,s]=(0,a.useState)({value:new Set(e.getAll("tags").filter(e=>B.includes(e)))}),[r,n]=(0,a.useState)(!0),l=(0,a.useMemo)(()=>[...Object.entries(C),["uncategorized",[...A]]],[]);(0,a.useEffect)(()=>{i(e=>{let t=e.toSorted((e,t)=>I(t,o.value).size-I(e,o.value).size);return o.value.size>0&&(t=t.filter(e=>I(e,o.value).size>0)),t})},[o,i]);let c=(0,a.useCallback)(e=>(0,t.jsx)("div",{className:"flex grow flex-col items-stretch",children:(0,t.jsx)(G,{value:e,checked:o.value.has(e)})},e),[o]),d=(0,a.useCallback)(e=>({category:"Categorias",language:"Linguagens",library:"Bibliotecas",uncategorized:"Sem categoria"})[e],[]),u=(0,a.useCallback)(()=>{n(e=>!e)},[]);return(0,t.jsx)("div",{className:"fixed bottom-4 left-1/2 -translate-x-1/2",children:(0,t.jsx)(y.default,{layout:!0,padding:r?void 0:0,children:(0,t.jsxs)("div",{className:"flex flex-col items-center gap-8",children:[r&&(0,t.jsx)(b.motion.fieldset,{className:"flex w-[80vw] flex-col gap-4 sm:w-auto",initial:{opacity:0},animate:{opacity:1},layout:!0,transition:{delay:.25},onChange:e=>{e.target instanceof HTMLInputElement?(window.scrollTo({top:0,behavior:"instant"}),e.target.checked?o.value.add(e.target.value):o.value.delete(e.target.value),s({value:o.value})):console.error("event.target is not an HTMLInputElement")},children:l.map(([e,a])=>(0,t.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,t.jsx)("div",{className:"text-lg font-bold",children:d(e)}),(0,t.jsx)("div",{className:"flex flex-row flex-wrap gap-2",children:a.map(e=>c(e))},e)]},e))}),(0,t.jsx)(b.motion.div,{layout:!0,children:(0,t.jsxs)(j.default,{onClick:u,children:[(0,t.jsxs)(b.motion.span,{animate:{rotate:`${180*!r}deg`},layout:!0,children:[(0,t.jsx)(H,{})," "]}),r?(0,t.jsx)(t.Fragment,{children:"Ocultar filtros"}):(0,t.jsx)(t.Fragment,{children:"Expandir filtros"})]})})]})})})}function J(){let[e,i]=(0,a.useState)(()=>e=>e),o=(0,a.useCallback)(e=>{i(()=>e)},[]),s=(0,a.useRef)(null);return(0,a.useLayoutEffect)(()=>{null==s.current?console.error("projectsListRef.current is null"):new Animation(new KeyframeEffect(s.current,[{opacity:0},{}],{duration:500,easing:"ease"})).play()},[e]),(0,t.jsx)("div",{className:"pt-[10vh]",children:(0,t.jsxs)(T.Provider,{value:{filter:e,setFilter:o},children:[(0,t.jsx)("div",{className:"flex flex-col items-center gap-32",children:(0,t.jsx)("div",{ref:s,className:"w-full max-w-screen-2xl px-4 pb-[100vh]",children:(0,t.jsx)(k,{})})}),(0,t.jsx)(a.Suspense,{children:(0,t.jsx)(E,{})})]})})}e.s(["default",()=>J],79221)}]);