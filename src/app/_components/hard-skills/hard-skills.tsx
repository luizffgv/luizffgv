        ...
        <div className="flex flex-col gap-16">
          <Skill title="TypeScript">
            <p>
              ...
              implementando soluções que equilibram esses fatores para aumentar
              a agilidade e reduzir a incidência de bugs.
            </p>
            <p>
          ...
          <Skill title="Publicação NPM">
            <p>
              ...
              <strong>publicação</strong> e <strong>manutenção</strong> de
              pacotes NPM, incluindo <strong>declarações de tipos</strong>,{" "}
          ...
          <Skill title="Git">
            <p>
              ...
              <strong>reescrever histórico</strong>, trabalhando
              confortavelmente tanto em fluxos que priorizam{" "}
              <strong>rebases</strong>, <strong>merge commits</strong>, e/ou{" "}
              <strong>squashes</strong>.
            </p>
          </Skill>
        </div>
      </TitledSection>
