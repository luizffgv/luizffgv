...
export interface ReactBitsRotatingTextRef {
  next: () => void;
  previous: () => void;
...
export interface ReactBitsRotatingTextProps
  extends Omit<
...
export const ReactBitsRotatingText = forwardRef<
  ReactBitsRotatingTextRef,
  ReactBitsRotatingTextProps
>(function ReactBitsRotatingText(
  {
    texts,
...
export default ReactBitsRotatingText;
