...
export default function Hero(): JSX.Element {
  return (
    <div className="isolate sm:min-h-auto relative flex min-h-screen flex-col items-center justify-center gap-32 overflow-x-hidden bg-primary py-64 text-fg-on-primary transition-colors dark:text-fg">
